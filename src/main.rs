   ...
   #[cfg(target_os = "windows")]
    {
        use platforms::windows::actions::{
            ...
            get_env_vars::EnvVarsSimulation,
            get_clipboard::ClipboardSimulation,
            ...
            time_manipulation_sim::TimeManipulationSimulation,
        ...
        register_windows_actions!(
            ...
            EnableRdpSimulation,
            DirectoryPermissionsSim,
            TimeManipulationSimulation,
            KeyloggerSim,
            RecordMicSim,
            RevSh,
            CreateProcSim,
